...
- Filter is the feature were users can set automated replies for a particular keyword and Sm18filter will respond whenever a keyword is found the message
